...
const Hero = () => {
    return (
        <section className="section" style={{ justifyContent: 'center', alignItems: 'flex-start', textAlign: 'left', minHeight: '100vh' }}>
            <div className="container" style={{ width: '100%', display: 'flex', alignItems: 'center' }}>
                <div style={{ maxWidth: '700px' }}>
                    ...
                    >
                        ...
                        <h1 className="text-gradient" style={{ marginBottom: '2rem', lineHeight: '1.1' }}>
                            Standardizing <br />
                            Satellite Ecosystem
                        </h1>

                        <p style={{ color: '#b0b0c0', marginBottom: '3rem', lineHeight: '1.7', maxWidth: '600px' }}>
                        ...
                        <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'center', flexWrap: 'wrap' }}>
                            ...
                            <a href="#platform" style={{ textDecoration: 'none' }}>
                                <button className="btn btn-secondary" style={{ background: 'transparent', border: '2px solid rgba(255,255,255,0.2)', color: '#fff', padding: '14px 32px' }}>
                                    Learn More
                                </button>
                            </a>
                        </div>
